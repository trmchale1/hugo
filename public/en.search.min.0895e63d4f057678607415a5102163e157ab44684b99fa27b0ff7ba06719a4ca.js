...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.cf35f6a18346c54802c4a83101197abb33fc1d42ca1359a7d6f525532d1a5e56.js',function(){input.required=false;search();});}
